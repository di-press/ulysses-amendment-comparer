...
class DocModelTopics(Resource):
    ...
    def post(self):
        ...
        result = DocModelTopics.repository.addModelTopics(projectLaw=projectLaw,topic_id=topic_id,terms=terms,configuration=configuration)

        return result,201
    
    @server.api.doc(responses={202: 'OK', 400: 'Parâmetros inválidos.', 500: 'Erro na API.'},
                    description='Essa rota exlui um registro.')
